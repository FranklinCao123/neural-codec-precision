"""Run module-wise FP16 weight experiments."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        required=True,
        help="Path to module-wise FP16 experiment config.",
    )
    parser.add_argument(
        "--device",
        default="auto",
...
def main() -> None:
    ...
    output_dir = PROJECT_ROOT / config.get("output", {}).get("dir", "results/raw/fp16_weights")
