"""Run the FP16 AMP codec and forward benchmark."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        default="configs/cheng2020_fp16.yaml",
...
def main() -> None:
    ...
    if config.get("precision", {}).get("mode") == "fp16" and device.type != "cuda":
    ...
    output_dir = PROJECT_ROOT / config.get("output", {}).get("dir", "results/raw/cheng2020_fp16")
